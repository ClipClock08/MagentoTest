...
namespace Brander\BlogTest\Ui\Component\Listing\Column;
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('blog/index/edit', ['id' => $item['post_id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('blog/index/delete', ['id' => $item['post_id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
